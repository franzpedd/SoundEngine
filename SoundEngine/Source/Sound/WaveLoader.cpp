...
namespace Cosmos::sound
{
        ...
        for (uint32_t i = 0; i < GetSamplesPerChannel(); i++)
        {
            for (uint32_t channel = 0; channel < GetChannels(); channel++)
            {
                switch (mBitDepth)
                {
                    ...
                    default:
                    {
                        std::cout << "Error: Trying to write a file with unsupported bit depth" << std::endl;
                        return false;
                    }
                }
            }
    ...
    bool WaveLoader::DecodeWaveFile(std::vector<uint8_t>& fileData)
    {
        ...
        {
            std::cout << "Error: This .wav file doesn't follow the standart Wave Format" << std::endl;
            return false;
        }
        ...
        {
            std::cout << "Error: This wave file is encoded in a unsupported format" << std::endl;
            return false;
        }
        ...
        {
            std::cout << "Error: This wave file is doesn't have a valid number of channels" << std::endl;
            return false;
        }
        ...
        {
            std::cout << "Error: This wave file has invalid header data" << std::endl;
            return false;
        }
        ...
        {
            std::cout << "Error: This wave file has an invalid bit depth" << std::endl;
            return false;
        }
    ...
    int32_t WaveLoader::GetIndexOfChunk(std::vector<uint8_t>& source, const std::string& chunkHeaderID, int32_t startIndex, Endianness endianness)
    {
        ...
        {
            std::cout << "Invalid chunk header ID" << std::endl;
            return -1;
        }
